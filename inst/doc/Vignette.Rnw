...
The package was built using R 2.12.2, although it should be compatible with
older versions of R. To obtain R 2.12.2 for Windows, follow this link:
\url{http://cran.r-project.org/bin/windows/base/R-2.12.2-win.exe}
